...
interface MediaPlayerContextType {
        ...
        if (videoUrlToPlay) {
           ...
           if (requested) {
             // If a specific video is requested, check if it's YouTube and apply overlay if needed
               ...
               }, [getRandomIntro, playSpecificVideo, fetchRandomDbVideo, isYouTubeVideo, setIsPlaying, setCurrentVideo, setOverlayIntroVideo, setIsPreRollOverlayActive]);
  ...
  }, [setVolume, getRandomIntro, fetchRandomDbVideo, currentVideo, nextVideo, nextDataVideoRef, isYouTubeVideo, setCurrentVideo, setIsPlaying, setOverlayIntroVideo, setIsPreRollOverlayActive]);
