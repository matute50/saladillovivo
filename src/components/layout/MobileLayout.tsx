...
const MOCK_DATA = {
  ...
  ads: [
    { id: 'ad1', cliente: 'Cliente A', imageUrl: '', url: '', tipo: 'banner', fecha_inicio: '', fecha_fin: '', activo: true },
    { id: 'ad2', cliente: 'Cliente B', imageUrl: '', url: '', tipo: 'banner', fecha_inicio: '', fecha_fin: '', activo: true },
    { id: 'ad3', cliente: 'Cliente C', imageUrl: '', url: '', tipo: 'banner', fecha_inicio: '', fecha_fin: '', activo: true },
    { id: 'ad4', cliente: 'Cliente A Repetido', imageUrl: '', url: '', tipo: 'banner', fecha_inicio: '', fecha_fin: '', activo: true },
    { id: 'ad5', cliente: 'Cliente B Repetido', imageUrl: '', url: '', tipo: 'banner', fecha_inicio: '', fecha_fin: '', activo: true }
  ]
};
  ...
  return (
    ...
    >
      <div className="relative w-full h-full">
        <Image
          src={news.imagen || 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII='}
      ...
      <Swiper slidesPerView={2.2} spaceBetween={10} className="w-full flex-1">
        {filtered.map((video) => (
          <SwiperSlide key={video.id} className="h-full">
            <div onClick={() => playSpecificVideo(video, volume, setVolume)} className="relative h-full w-full rounded-lg overflow-hidden bg-neutral-800 border border-neutral-700/50 cursor-pointer">
              <Image src={video.imagen || 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII='} alt={video.nombre} fill className="object-cover opacity-90" />
  ...
  return (
    <div className="fixed inset-0 z-[100] flex flex-col w-full h-[100dvh] bg-black text-foreground overflow-y-auto">
      <div className="shrink-0 bg-black">
        <NewsTicker tickerTexts={data.tickerTexts} />
      </div>
            ...
            {adsSlides.map((ad, idx) => (
              <SwiperSlide key={`ad-${idx}`}>
                <div className="relative w-full h-full rounded-lg overflow-hidden border border-white/10 bg-black">
                  <Image src={ad.imageUrl || 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII='} alt="Publicidad" fill className="object-cover" />
